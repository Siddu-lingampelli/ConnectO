    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 w-full">
        ...
        <motion.div 
          ...
          className="relative bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 rounded-2xl overflow-hidden shadow-lg mb-8"
        >
          {/* Background Pattern */}
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-4">
                <motion.div 
                  ...
                  className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/30 shadow-lg"
                >
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-white text-emerald-700 rounded-xl hover:shadow-xl transition-all font-semibold flex items-center justify-center gap-2 hover:bg-emerald-50"
              >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-500 mt-1.5">
                            ...
                            <span className="px-2 py-0.5 bg-gray-100 rounded-full text-gray-700 font-medium">{post.category}</span>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-gray-600 hover:text-emerald-600 transition-all font-medium"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
            ...
            {totalPages > 1 && (
              ...
              >
                <motion.button
                  ...
                  className="px-4 py-2 bg-white rounded-lg border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-all font-medium text-gray-700 flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
