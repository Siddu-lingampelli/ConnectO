      ...
      <main className="flex-1 w-full">
        <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-2xl overflow-hidden mb-8 border border-neutral-200 shadow-soft"
          >
            {/* Background Pattern */}
            ...
            <div className="relative px-6 py-8 sm:px-10 sm:py-12">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                >
                  <div className="bg-neutral-50 rounded-xl px-6 py-4 border border-neutral-200">
                    <div className="text-neutral-600 text-sm font-medium mb-1">Balance</div>
                    <div className="text-2xl font-bold text-neutral-900">₹0</div>
                  </div>
                  <div className="bg-neutral-50 rounded-xl px-6 py-4 border border-neutral-200">
                    <div className="text-neutral-600 text-sm font-medium mb-1">Rating</div>
          ...
          {!isVerified && (
            <motion.div
              ...
              className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8 flex items-start gap-4"
            >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="text-3xl font-bold text-gray-900 mb-1">{user.completedJobs || 0}</div>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="w-12 h-12 bg-amber-100 rounded-lg flex items-center justify-center">
                    <CurrencyIcon className="w-6 h-6 text-amber-600" />
                  </div>
                </div>
                <div className="text-3xl font-bold text-gray-900 mb-1">₹0</div>
