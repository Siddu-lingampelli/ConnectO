      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-xl shadow-soft border border-border p-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-text-secondary mb-3">When you register on ConnectO, we may collect:</p>
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-3">1.2 Usage Information</h3>
            <p className="text-text-secondary mb-3">We automatically collect certain information when you use our platform:</p>
          ...
          <section>
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-3">3.1 Other Users</h3>
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-3">3.2 Service Providers</h3>
            <p className="text-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-3">3.3 Legal Requirements</h3>
            <p className="text-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-text-primary mb-3">3.4 Business Transfers</h3>
          ...
          <section>
            ...
            <p className="text-text-secondary mt-3">
              To exercise these rights, contact us at <a href="mailto:admin@vsconnecto.com" className="text-text-secondary hover:text-text-primary">admin@vsconnecto.com</a>
            </p>
          </section>

          {/* Cookies */}
          <section>
            <h2 className="text-2xl font-bold text-text-primary mb-4">6. Cookies and Tracking Technologies</h2>
            <p className="text-text-secondary mb-3">
