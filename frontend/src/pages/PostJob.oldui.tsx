...
import { LockIcon, XCircleIcon, DocumentIcon, ClockIcon } from '../components/icons/PremiumIcons';
              ...
              <div className="border-t-2 border-[#AEC3B0] pt-6">
                <div className="flex gap-4">
                  ...
                  <button
                    ...
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-[#345635] to-[#6B8F71] text-white rounded-xl hover:shadow-xl transition-all disabled:opacity-50 font-semibold hover:scale-105 flex items-center justify-center gap-2"
                  >
                    {submitting ? (
                      <>
