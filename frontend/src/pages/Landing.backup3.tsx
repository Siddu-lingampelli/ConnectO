...
// Professional Freelancing Platform Landing Page with Framer Motion
const Landing = () => {
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <motion.div 
            ...
            className="absolute top-40 right-10 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20"
          />
          <motion.div 
            animate={{ 
              x: [0, 30, 0],
            ...
            className="absolute -bottom-8 left-1/2 w-72 h-72 bg-green-300 rounded-full mix-blend-multiply filter blur-3xl opacity-15"
          />
        </div>
