    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 w-full">
        ...
        <motion.div 
          ...
          className="relative bg-gradient-to-r from-primary via-primary to-primary-dark rounded-2xl overflow-hidden shadow-soft mb-8"
        >
          {/* Background Pattern */}
          ...
          <div className="relative px-8 py-10">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-3xl md:text-4xl font-semibold mb-2 text-white">Community Hub</h1>
              ...
              <motion.button
                ...
                className="px-6 py-3 bg-white text-primary rounded-xl hover:shadow-medium transition-all font-semibold flex items-center justify-center gap-2 hover:bg-primary/5"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                {postTypes.map(type => (
                  <motion.button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-xl transition-all text-sm font-medium flex items-center gap-2 ${
          ...
          >
            {loading ? (
              ...
              >
                <div className="w-20 h-20 bg-primary/5 rounded-full mx-auto mb-4 flex items-center justify-center">
                ...
                >
                  ...
                  <div className="p-6 border-b border-gray-100">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-4">
                        <div 
                          className="w-12 h-12 rounded-full bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-white text-lg font-semibold cursor-pointer hover:shadow-md transition-shadow"
                      ...
                      {post.author._id === currentUser?._id && (
                        <button
                          ...
                          className="text-red-500 hover:text-red-700 text-sm font-medium flex items-center gap-1.5 hover:bg-red-50 px-3 py-1.5 rounded-xl transition-colors"
                        >
                    ...
                    {post.tags.length > 0 && (
                      <div className="flex flex-wrap gap-2 mt-4">
                        {post.tags.map((tag, idx) => (
                          <span key={idx} className="px-3 py-1 bg-primary/5 text-primary rounded-full text-sm font-medium">
                            #{tag}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 text-text-secondary hover:text-primary transition-all font-medium"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                    ...
                    <div className="px-6 pb-6 border-t border-gray-100 bg-gray-50">
                      ...
                      <div className="mt-4 flex gap-3">
                        <input
                          ...
                          className="flex-1 px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm"
                          onKeyPress={(e) => {
                            if (e.key === 'Enter') {
                        ...
                        <button
                          ...
                          className="px-6 py-2.5 bg-primary text-white rounded-xl hover:bg-primary-dark transition-all font-medium flex items-center gap-2"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="mt-4 space-y-3">
                        {post.comments.map(comment => (
                          <div key={comment._id} className="flex gap-3">
                            <div className="w-8 h-8 rounded-full bg-gradient-to-br from-border to-border flex items-center justify-center text-white text-sm font-semibold flex-shrink-0">
            ...
            {totalPages > 1 && (
              ...
              >
                <motion.button
                  ...
                  className="px-4 py-2 bg-white rounded-xl border border-gray-300 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-all font-medium text-text-secondary flex items-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showCreateModal && (
        ...
        >
          ...
          >
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-surface to-surface">
                ...
                <div className="grid grid-cols-4 gap-2">
                  {postTypes.filter(t => t !== 'all').map(type => (
                    <motion.button
                      ...
                      className={`px-4 py-2.5 rounded-xl transition-all font-medium flex items-center justify-center gap-2 ${
            ...
            <div className="p-6 border-t border-gray-200 bg-gray-50 flex justify-end gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => setShowCreateModal(false)}
                className="px-6 py-2.5 border border-gray-300 rounded-xl hover:bg-gray-100 transition-all font-medium text-text-secondary"
              >
                Cancel
              </motion.button>
              <motion.button
                ...
                className="px-6 py-2.5 bg-primary text-white rounded-xl hover:bg-primary-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed font-medium flex items-center gap-2"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8" />
                </svg>
