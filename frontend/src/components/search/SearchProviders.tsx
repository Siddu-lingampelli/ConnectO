...
const SearchProviders = () => {
  ...
  const handleSearch = async () => {
    try {
      ...
      // Use the dedicated searchProviders endpoint
      ...
      toast.error(error.response?.data?.message || 'Failed to search providers');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">🔍 Find Service Providers</h2>
